...
/**
 * Servlet implementation class ThumbnailDetailServelt
 */
...
public class ThumbnailDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board board = service.selectBoard(bid);// 보드 가져오고
		
		ArrayList<Attachment> fileList = service.selectThumbnail(bid); // 상세정보 가져와야함
