...
<%
	...
	System.out.println(loginUser); //null이면 로그인을 안한것 null이 아니면 로그인 한것
	...
	<% if(loginUser == null){ %>
		...
		<% }else{ %>
			<div id="userInfo" align="right">
				...
				<div class="btns">
					<div id="myPageBtn" onclick="myPage();" cursor=pointer;>내 정보보기</div>
					<div id="logoutBtn" onclick="logout();" cursor=pointer;>로그아웃</div>
				</div>
			</div>
		<% } %>
	</div>
