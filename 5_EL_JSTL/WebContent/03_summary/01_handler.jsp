...
<body>
		...
		<table>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button" value="전송" onClick="goSubmit(0);"> <!-- 전송을 누르면 0이 전송 -->
	...
	<script type="text/javascript">
		function goSubmit(flag){
			var frm = document.personFrm; // frm 폼 변수 = 폼 자체 
			if(flag == 0){ //폼에서 전송 받아온 숫자가 0이면 
				frm.view.value = "02_scriptlet.jsp"; // view태그의 밸류값으로 주소를 넣음
			} else if(flag == 1){
